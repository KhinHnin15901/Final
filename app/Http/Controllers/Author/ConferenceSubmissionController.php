...
class ConferenceSubmissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('paper')) {
            $validated['paper_path'] = $request->file('paper')->store('conferences/papers', 'public');
        }

        if ($request->hasFile('department_rule_file')) {
            $validated['department_rule_path'] = $request->file('department_rule_file')->store('conferences/dept_rules', 'public');
        }

        if ($request->hasFile('professor_rule_file')) {
            $validated['professor_rule_path'] = $request->file('professor_rule_file')->store('conferences/prof_rules', 'public');
        }
