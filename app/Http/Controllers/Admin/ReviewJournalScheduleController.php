...
class ReviewJournalScheduleController extends Controller
{
    ...
    public function journalschedule(Request $request)
    {
        ...
        $allPapers = JournalSubmission::with('topics', 'event', 'user')->get();
        ...
        if ($topicId) {
            ...
            $papers = JournalSubmission::where('topic_id', $topicId)
                ...
                ->with('topics', 'event', 'user') // ensure no record in review table
                ->get();
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'reviewer1_id' => 'required|exists:users,id|different:reviewer2_id|different:reviewer3_id',
            'reviewer2_id' => 'required|exists:users,id|different:reviewer1_id|different:reviewer3_id',
            'reviewer3_id' => 'required|exists:users,id|different:reviewer1_id|different:reviewer2_id',
