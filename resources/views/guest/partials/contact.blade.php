<section class="bg-white shadow-md shadow-[#d6dd42] rounded-lg px-4 sm:px-6 lg:px-8 font-[Arial,sans-serif] max-w-3xl mx-auto min-h-screen flex flex-col justify-center mt-10">
