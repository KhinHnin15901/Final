...
@section('main-content')
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">New Conference</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">New Conference Entry</h5>
                ...
                <form method="POST" action="{{ route('admin.conferences.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="papers" class="form-label">Upload Papers</label>
                        <input type="file" name="papers[]" multiple
                            class="form-control @error('papers') is-invalid @enderror" accept=".pdf,.doc,.docx">
                        @error('papers')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
