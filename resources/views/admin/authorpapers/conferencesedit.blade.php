...
@section('main-content')
    <div class="container mt-10 max-w-3xl mx-auto neo-card p-8 rounded-2xl bg-gray-50">
        <h2 class="text-2xl font-bold mb-6 text-center">✏️ Edit Conference Submission</h2>
        ...
        <form method="POST" action="{{ route('admin.papers.conferenceupdate', $submission->id) }}"
            ...
            <div class="mb-4">
                ...
                <select name="keywords" class="form-select w-full rounded p-2">
                    <option value="">-- Choose Keyword --</option>
                    @foreach ($allKeywords as $keyword)
                        <option value="{{ $keyword->name }}"
                            {{ old('keywords', $submission->keywords) == $keyword->name ? 'selected' : '' }}>
            ...
            <div class="mt-4">
                ...
                <label class="block font-semibold mb-1">Department Rule File</label><br>
            ...
            <div class="mt-4">
                ...
                <label class="block font-semibold mb-1">Professor Rule File</label><br>
