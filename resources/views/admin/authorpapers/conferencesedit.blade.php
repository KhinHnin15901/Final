...
<section class="section d-flex justify-content-center" style="font-family: Arial, sans-serif; padding: 30px;">
    <div class="card" style="max-width: 900px; width: 100%; padding: 24px; background: #fff; border-radius: 12px; box-shadow: 0 4px 15px rgba(214, 221, 66, 0.6); border-top: 4px solid #027c7d;">
        <h4 class="text-center mb-6 fw-bold" style="color: #000120; font-size: 20px;">
            ✏️ Edit Conference Submission
        </h4>

        <form method="POST" action="{{ route('admin.papers.conferenceupdate', $submission->id) }}" enctype="multipart/form-data" class="row g-3">
            @csrf
            @method('PUT')
            ...
            <div class="col-12 text-center mt-4">
                <button type="submit" class="btn text-white px-5 py-2 shadow" style="background-color:#027c7d; font-weight:600; border-radius:8px; transition:all 0.3s;">Update Submission</button>
            </div>
        </form>
    </div>
</section>
