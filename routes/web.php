...
Route::middleware('auth')->group(function () {
    ...
    Route::put('/conference/update/{id}', [ReviewerResponseController::class, 'updateConference'])
        ->name('conference.update');
    Route::put('/conference/{id}', [ConferenceSubmissionController::class, 'update'])->name('conferences.update');

    Route::put('/journal/update/{id}', [ReviewerResponseController::class, 'updateJournal'])
